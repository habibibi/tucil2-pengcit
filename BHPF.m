function outImg = BHPF(img, D0, n)
% IHPF Melakukan Butterworth high pass filter melalui ranah frekuensi
%   D0  : frekuensi cutoff
%   n   : orde butterworth
    if nargin < 3
        n = 1;
    ...
    for ch = 1:C
        ...
        % Membuat mask BHPF dengan cutoff frekuensi D0 dan order n
        H = 1./(1 + (D./D0).^(2*n)); 
        H = fftshift(1-H);
